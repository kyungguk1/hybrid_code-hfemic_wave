...
struct Input {
    ...
    static constexpr auto part_descs = std::make_tuple(
            BiMaxPlasmaDesc({ { 1, 114.9786154030392, 3 }, 10000, _2nd, full_f }, 0.000020614306328592046, 35.0),
    ...
    ///
    static constexpr std::pair<unsigned, Range> particle_recording_frequency = { 200, { 1000, 5000 } };
    ...
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v2hist_specs = {
            std::make_pair(Range{ 0, 1} * 0.17, 200),
